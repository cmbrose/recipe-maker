class LoveAndLemons::Type1
  def self.can_use(document)
    !LoveAndLemons::Type1.find_root_path(document).nil?
  end

  def initialize(document)
    @document = document
    @root_path = LoveAndLemons::Type1.find_root_path(document)
  end
